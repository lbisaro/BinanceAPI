    ...
    */
    ...
    public function getSymbolData($symbol)
    {
        ...
        if ($price > 0)
        {
            ...
            $data['qtyDecsPrice'] = $this->numberOfDecimals($exchangeInfo['symbols'][$symbol]['filters'][0]['minQty']);
        }
    ...
    public function orderTradeInfo($symbol,$orderId)
    {
        $parameters = [
            "symbol" => $symbol,
            "orderId" => $orderId,
